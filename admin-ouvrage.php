...
<head>
  ...
  <title>The Reading Room - Ouvrage</title>
...
<a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="./admin-panel.php">
    ...
    <ul class="navbar-nav px-3">
      ...
      <a class="nav-link" href="./logout.php">Sign out - <?php echo $result['bib_nom'];?></a>      </li>
    </ul>
  </nav>
...
$("#search-input").on("input", function() {
    ...
    $("#book-table tbody tr").each(function() {
        ...
        let ouvreAuteur = $(this).find("td:nth-child(4)").text().toLowerCase();
        if (ouvreTitre.includes(searchTerm) || ouvreAuteur.includes(searchTerm)) {
            $(this).show();
        } else {
            $(this).hide();
        }
